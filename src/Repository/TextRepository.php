...
class TextRepository extends ServiceEntityRepository
{
    ...
    public function getAllPages()
    {
        ...
        ->select(' page.page_num as page_num, page.annex, page.annex_title, page.part, page.part_title, page.article, page.article_title, page.title, page.title_title, page.text')
